...
const NAIL_TYPES = [
  new Type(
    ...
    "nails",
    "Manucure russe",
    "Soin précis des cuticules pour un fini impeccable.",
    "/photos/classic.jpeg",
    55,
    "1h30",
    20,
  ...
  new Type(
    ...
    "nails",
    "Gel dur",
    "Renforcement durable pour des ongles solides et élégants.",
    "/photos/volume.jpeg",
    60,
    "2h",
    20,
  ...
  new Type(
    ...
    "nails",
    "Gel-X",
    "Extensions légères offrant un résultat naturel et moderne.",
    "/photos/hybrid.jpeg",
    35,
    "0h45",
    10,
